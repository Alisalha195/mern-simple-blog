...
export const useSearchBox = () => {
	...
	return (
		...
		<div className={openSearchBox ? "  flex flex-row justify-center  bg-[#1e343d]/[.89]  [height:100vh] [width:100vw]   [position:fixed] [top:0] [left:0]" : "hidden"}

		>

			<div className={openSearchBox ? " flex flex-col bg-[#1e343d] p-1  xs:[width:90vw] md:[width:70vw] lg:[width:60vw] xl:[width:50vw]   [position:fixed] [top:10px]  [z-index:200] [border:2px_solid_#aaa] [border-radius:10px]"
	          : "hidden" }
...
export const handleOpenSearchBox
