...
const DeleteBox = ({userId ,username ,open , handleOpenDeleteBox}) => {  
	
	const dispatch = useDispatch()
	const [waiting , setWaiting]  = useState(false)

	const deleteUesrUrl = "http://localhost:5000/api/users/delete"
	...
	const handleDeleteClick = async() => {
		...
		try {
			setWaiting(true);
			const res = await fetch(`${deleteUesrUrl}/${userId}`,{
				method:"DELETE"
