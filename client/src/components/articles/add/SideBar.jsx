...
const SideBar = ({handlePublishClick}) => {
	return (
		<div className=" flex flex-col justify-evenly py-2 xs:px-2 md:px-3 [height:100%] xs:mb-[100px] xs:mt-[14px] lg:mt-[0]">
			...
			<div className=" flex 	xs:mt-8 lg:mt-2">
				<span className="btn xs:py-[2px] xs:px-[8px] md:py-[4px] md:px-2 
				         xs:text-[23px] md:text-[26px] text-gray-200 bg-gray-700 [border-radius:7px]"
